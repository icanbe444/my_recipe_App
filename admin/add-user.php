...
<head>
    ...
    <title>Add User - <?php echo BLOG_NAME?></title>
    <!-- BEGIN: CSS Assets-->
...
$db_con->exec("insert into users values('$id','$name','$email','$password','$regdate')");
...
<h4 style="margin:30px;font-size:20px;color:darkred">Add New User</h4>
...
<input type="submit" name="add" value="Add User" class="transition duration-200 border shadow-sm inline-flex items-center justify-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&amp;:hover:not(:disabled)]:bg-opacity-90 [&amp;:hover:not(:disabled)]:border-opacity-90 [&amp;:not(button)]:text-center disabled:opacity-70 disabled:cursor-not-allowed bg-primary border-primary text-white dark:border-primary w-24">
</div>
</form>
                </div>
            </div>

...
<head>
    ...
    <title>View User - <?php echo BLOG_NAME?></title>
    <!-- BEGIN: CSS Assets-->
...
{
$page_id = $_GET['id'];
$run_query =$db_con->prepare("select * from users where u_id=?");
...
<h4 style="padding:20px;">You are viewing : <?php echo $fullname?>'s Profile</h4>

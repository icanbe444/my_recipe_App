...
<?php
    ...
    if (isset($_POST['login'])) {
        ...
        try {
            $stmt = $db_con->prepare("SELECT * FROM chefs WHERE email=:email");
            ...
            if ($row['password'] == $password) {
                ...
                if ($role == 'admin') {
                    ...
                    $_SESSION['chef_session'] = $row['user_id'];
                    echo "<script>
                            alert('Login Successful (Chef)');
                            window.location.href='admin/';
                          </script>";
                } else {
...
?>
    ...
    <script src="admin/dist/js/vendors/dom.js"></script>
    <script src="admin/dist/js/vendors/tailwind-merge.js"></script>
    <script src="admin/dist/js/vendors/lucide.js"></script>
    <script src="admin/dist/js/vendors/modal.js"></script>
    <script src="admin/dist/js/components/base/theme-color.js"></script>
    <script src="admin/dist/js/components/base/lucide.js"></script> <!-- END: Vendor JS Assets-->
